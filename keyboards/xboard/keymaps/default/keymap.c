...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN] = LAYOUT_tkl_ansi(
        QK_BOOT,              QK_OUTPUT_USB,    QK_OUTPUT_BLUETOOTH,    RGB_MODE_REVERSE,    RGB_MODE_FORWARD,    RGB_VAD,    RGB_VAI,    KC_MEDIA_PREV_TRACK,    KC_MEDIA_PLAY_PAUSE,    KC_MEDIA_NEXT_TRACK,    KC_AUDIO_MUTE,   KC_AUDIO_VOL_DOWN,  KC_AUDIO_VOL_UP,    KC_TRNS, KC_TRNS, KC_TRNS,
